...
--
-- Host: mysql:3306
-- Generation Time: May 03, 2025 at 10:30 AM
...
CREATE TABLE `orders` (
  ...
  `status` enum('PENDING','CONFIRMED','SHIPPED','DELIVERED','CANCELLED') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE `roles` (
  ...
  `role_name` enum('ADMIN','CUSTOMER') COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `carts`
  MODIFY `cart_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `cart_items`
--
ALTER TABLE `cart_items`
  MODIFY `cart_item_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
