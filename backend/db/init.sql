...
--
-- Host: mysql:3306
-- Generation Time: Jun 18, 2025 at 08:31 AM
...
CREATE TABLE `orders` (
  ...
  `shipping_city` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `shipping_postal_code` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`order_id`, `user_id`, `total_amount`, `status`, `order_date`, `updated_at`, `payment_method`, `shipping_name`, `shipping_address`, `shipping_city`, `shipping_postal_code`) VALUES
...
--
ALTER TABLE `products`
  MODIFY `product_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `wishlists`
  MODIFY `wishlist_id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `wishlist_items`
--
ALTER TABLE `wishlist_items`
  MODIFY `wishlist_item_id` bigint NOT NULL AUTO_INCREMENT;
